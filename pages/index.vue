  ...
  >
    ...
    <transition name="drop">
      ...
      >
        <div
          class="logo w-4 m-4"
          v-html="require(`~/assets/icons/logo-4.svg?include`)"
        ></div>
        <button
          class="
            p-3
    ...
    <div class="px-4">
      ...
      <h1
        ...
        "
      >
        Get Your Own Digital Business Cards Hosted On Your Own Website!
      </h1>
      <p class="mt-8 text-lg md:text-xl w-full md:w-3/4 text-gray-200">
        We helps you create beautiful, responsive HTML&#8209;based
