export default {
  ...
  meta: {
    ...
    // ogUrl: false,
    ogTitle: 'Digital Business Card Generator',
    ogDescription:
      'Our tool helps you create beautiful, Digital business cards that can be hosted on your website.',
    ogSiteName: 'Digital Business Card Generator',
    theme_color: '#111827',
    author: 'Mr Delts',
    lang: 'en',
  ...
  head: {
    ...
    meta: [
      ...
      { name: 'viewport', content: 'width=device-width, initial-scale=1' },
      {
        ...
        name: 'description',
        content:
          'Our Tool helps you create beautiful, responsive digital business cards that can be hosted on your website.',
      },
      {
